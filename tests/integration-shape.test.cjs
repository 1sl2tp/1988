...
assert.match(app,/LOCAL_DATA_SCHEMA_VERSION="322"/);
...
assert.match(refresh,/server-scope-policy-v6/);
...
assert.match(html,/sw\.js\?v=322/);
assert.match(sw,/1988-main-watch-browse-v322/);
