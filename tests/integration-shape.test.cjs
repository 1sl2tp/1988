...
assert.match(refresh,/const LIVE_PIPELINE_VERSION=["']live-v19["']/);
...
assert.match(refresh,/const verifiedExternalRows=\(await discoverGlobalLiveCandidates/);
assert.match(refresh,/const selectedLiveRows=\(await mapLimit\(selectedLiveSources,10/);
